...
pub use protocol::{
    ...
    WalletPolicy, DEFAULT_REPLAY_WINDOW_SECS, DESCRIPTOR_ACK_TIMEOUT_SECS,
    ...
    MAX_MESSAGE_TYPE_LENGTH, MAX_NAME_LENGTH, MAX_PARTICIPANTS, MAX_RECOVERY_TIERS,
    MAX_SIGNATURE_SHARE_SIZE, MAX_XPUB_LENGTH, VALID_NETWORKS,
};
